...
- **[Recipe Loops](/docs/recipe-loops)** - version-control your loops as YAML files in `.loops/recipes/`
- **[Agent Workflows](/docs/agent-workflows)** - automate AI coding agents on a cadence
- **[OpenTelemetry](/docs/opentelemetry)** - built-in tracing for loops, tasks, and agent commands
