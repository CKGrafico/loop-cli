...
<Cards>
  ...
  <Card href="/docs/recipe-loops" title="Recipe Loops">
    Version-control your loops as YAML files in <code>.loops/recipes/</code>.
  </Card>
  <Card href="/docs/agent-workflows" title="Agent Workflows">
    Give an AI agent a cadence and let it iterate.
  </Card>
  <Card href="/docs/opentelemetry" title="OpenTelemetry">
...
Check the [Troubleshooting](/docs/troubleshooting) page or [open an issue on GitHub](https://github.com/PlainConceptsPlatform/loop-task/issues).
