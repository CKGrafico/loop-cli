...
Manage OpenTelemetry configuration. When called without a subcommand, shows the current telemetry status. See [OpenTelemetry](/docs/opentelemetry) for the full guide.
