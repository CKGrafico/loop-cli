...
const PACKAGE_NAME = '@plainconceptsplatform/loop-task'
 ...
 *
 * Read here rather than imported into lib/site.ts: the manifest sits outside this
 * Next project, and webpack parses an out-of-scope .json as JavaScript.
 */
